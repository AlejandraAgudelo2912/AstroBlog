...
<head>
    ...
    <title>AstroBlog API Documentation</title>
    ...
    <script src="../docs/js/tryitout-5.0.1.js"></script>

    <script src="../docs/js/theme-default-5.0.1.js"></script>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-DELETEapi-tags--id-">DELETE api/tags/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-map">
                                <a href="#endpoints-GETapi-map">GET api/map</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-map">
                                <a href="#endpoints-POSTapi-map">POST api/map</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-map--observationPoint_id-">
                                <a href="#endpoints-GETapi-map--observationPoint_id-">GET api/map/{observationPoint_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-map--observationPoint_id-">
                                <a href="#endpoints-PUTapi-map--observationPoint_id-">PUT api/map/{observationPoint_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-map--observationPoint_id-">
                                <a href="#endpoints-DELETEapi-map--observationPoint_id-">DELETE api/map/{observationPoint_id}</a>
                            </li>
...
<div class="bash-example">
    ...
    --form "published_at=architecto"\
    --form "category_id=architecto"\
    --form "cover_image=@C:\Users\aleja\AppData\Local\Temp\phpA7BB.tmp" </code></pre></div>
...
body.append('published_at', 'architecto');
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="cover_image"                data-endpoint="POSTapi-posts"
               value=""
               data-component="body">
    <br>
<p>El campo value debe ser una imagen. El campo value no debe ser mayor que 1024 kilobytes. Example: <code>C:\Users\aleja\AppData\Local\Temp\phpA7BB.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    \"status\": \"draft\",
    \"visibility\": \"private\",
    \"published_at\": \"2025-02-23T11:07:04\"
}"
</code></pre></div>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>public</code></li> <li><code>draft</code></li> <li><code>archived</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               value="2025-02-23T11:07:04"
               data-component="body">
    <br>
<p>El campo value debe ser una fecha válida. Example: <code>2025-02-23T11:07:04</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/posts/architecto/comments" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/posts/architecto/comments"
);
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="POSTapi-posts--post_id--comments"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/posts/architecto/comments/maiores-quia-adipisci-consequuntur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/posts/architecto/comments/maiores-quia-adipisci-consequuntur"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="maiores-quia-adipisci-consequuntur"
               data-component="url">
    <br>
<p>The ID of the comment. Example: <code>maiores-quia-adipisci-consequuntur</code></p>
            </div>
                    </form>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-posts--post_id--comments--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="body"                data-endpoint="PUTapi-posts--post_id--comments--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="DELETEapi-posts--post_id--comments--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="body"                data-endpoint="DELETEapi-posts--post_id--comments--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<p>The ID of the tag. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-map">GET api/map</h2>
...
<span id="execution-results-GETapi-map" hidden>
    ...
    <pre class="json"><code id="execution-response-content-GETapi-map"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-map" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-map">
...
<form id="form-GETapi-map" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-map');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-map"
                    onclick="cancelTryOut('GETapi-map');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-map"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-map"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-map"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-map">POST api/map</h2>
...
<span id="example-requests-POSTapi-map">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-map">
</span>
<span id="execution-results-POSTapi-map" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-map"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-map"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-map" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-map">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-map" data-method="POST"
      data-path="api/map"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-map', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-map"
                    onclick="tryItOut('POSTapi-map');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-map"
                    onclick="cancelTryOut('POSTapi-map');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-map"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-map"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-map"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-map"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-map"
               value=""
               data-component="body">
    <br>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="latitude"                data-endpoint="POSTapi-map"
               value="4326.41688"
               data-component="body">
    <br>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="longitude"                data-endpoint="POSTapi-map"
               value="4326.41688"
               data-component="body">
    <br>
<p>Example: <code>4326.41688</code></p>
                    ...
                    <h2 id="endpoints-GETapi-map--observationPoint_id-">GET api/map/{observationPoint_id}</h2>
...
<span id="example-requests-GETapi-map--observationPoint_id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/map/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-map--observationPoint_id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-map--observationPoint_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-map--observationPoint_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-map--observationPoint_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-map--observationPoint_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-map--observationPoint_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-map--observationPoint_id-" data-method="GET"
      data-path="api/map/{observationPoint_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-map--observationPoint_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-map--observationPoint_id-"
                    onclick="tryItOut('GETapi-map--observationPoint_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-map--observationPoint_id-"
                    onclick="cancelTryOut('GETapi-map--observationPoint_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-map--observationPoint_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/map/{observationPoint_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-map--observationPoint_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-map--observationPoint_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>observationPoint_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="observationPoint_id"                data-endpoint="GETapi-map--observationPoint_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the observationPoint. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PUTapi-map--observationPoint_id-">PUT api/map/{observationPoint_id}</h2>
...
<span id="example-requests-PUTapi-map--observationPoint_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-map--observationPoint_id-">
</span>
<span id="execution-results-PUTapi-map--observationPoint_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-map--observationPoint_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-map--observationPoint_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-map--observationPoint_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-map--observationPoint_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-map--observationPoint_id-" data-method="PUT"
      data-path="api/map/{observationPoint_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-map--observationPoint_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-map--observationPoint_id-"
                    onclick="tryItOut('PUTapi-map--observationPoint_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-map--observationPoint_id-"
                    onclick="cancelTryOut('PUTapi-map--observationPoint_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-map--observationPoint_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-map--observationPoint_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-map--observationPoint_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="observationPoint_id"                data-endpoint="PUTapi-map--observationPoint_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the observationPoint. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-map--observationPoint_id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-map--observationPoint_id-"
               value=""
               data-component="body">
    <br>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="latitude"                data-endpoint="PUTapi-map--observationPoint_id-"
               value="4326.41688"
               data-component="body">
    <br>
<p>Example: <code>4326.41688</code></p>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="longitude"                data-endpoint="PUTapi-map--observationPoint_id-"
               value="4326.41688"
               data-component="body">
    <br>
<p>Example: <code>4326.41688</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-map--observationPoint_id-">DELETE api/map/{observationPoint_id}</h2>
...
<span id="example-requests-DELETEapi-map--observationPoint_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-map--observationPoint_id-">
</span>
<span id="execution-results-DELETEapi-map--observationPoint_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-map--observationPoint_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-map--observationPoint_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-map--observationPoint_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-map--observationPoint_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-map--observationPoint_id-" data-method="DELETE"
      data-path="api/map/{observationPoint_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-map--observationPoint_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-map--observationPoint_id-"
                    onclick="tryItOut('DELETEapi-map--observationPoint_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-map--observationPoint_id-"
                    onclick="cancelTryOut('DELETEapi-map--observationPoint_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-map--observationPoint_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-map--observationPoint_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-map--observationPoint_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="observationPoint_id"                data-endpoint="DELETEapi-map--observationPoint_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the observationPoint. Example: <code>1</code></p>
