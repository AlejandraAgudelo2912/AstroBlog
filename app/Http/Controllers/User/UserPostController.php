...
class UserPostController extends Controller
{
    ...
    public function store(StorePostRequest $request)
    {
        ...
        return redirect()->route('user.posts.index')->with('success', 'Post creado correctamente.');
    }
    ...
    public function update(UpdatePostRequest $request, Post $post)
    {
        ...
        return redirect()->route('user.posts.index')->with('success', 'Post actualizado correctamente.');
    }
